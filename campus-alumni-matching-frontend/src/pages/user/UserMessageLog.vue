<template>
    ...
    <UserMessageList :message-list="messageList" :loading="loading_message" v-if="choose === true"/>
...
import UserMessageList from "../../components/UserMessageList.vue";
